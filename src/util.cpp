...
const char * const BITCOIN_CONF_FILENAME = "IH.conf";
const char * const BITCOIN_PID_FILENAME = "IHd.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\IH
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\IH
    // Mac: ~/Library/Application Support/IH
    // Unix: ~/.IH
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "IH";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/IH";
#else
    // Unix
    return pathRet / ".IH";
#endif
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("IH Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The IH Core developers";
    }
