...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("IH");
    case mBTC: return QString("mIH");
    case uBTC: return QString::fromUtf8("μIH");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("IHs");
    case mBTC: return QString("Milli-IHs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-IHs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
