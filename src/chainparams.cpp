...
{
    const char* pszTimestamp = "Jul 28, 2018 IH";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x000005004f4e38c08800aec940effa2692f3a617e31bf7073d2178d44edc2658");
        ...
        consensus.defaultAssumeValid = uint256S("0x000005004f4e38c08800aec940effa2692f3a617e31bf7073d2178d44edc2658"); //0
        ...
        genesis = CreateGenesisBlock(1530115200, 6286575, 0x1f00ffff, 1, 50 * COIN);
...
public:
    CTestNetParams() {
        ...
        consensus.nSubsidyHalvingInterval = 985500;
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("000005004f4e38c08800aec940effa2692f3a617e31bf7073d2178d44edc2658");
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("000005004f4e38c08800aec940effa2692f3a617e31bf7073d2178d44edc2658");
        ...
        genesis = CreateGenesisBlock(1530115200, 6286575, 0x1f00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("000005004f4e38c08800aec940effa2692f3a617e31bf7073d2178d44edc2658"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("IH4.dynu.net", "IH4.dynu.net", false));
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("000005004f4e38c08800aec940effa2692f3a617e31bf7073d2178d44edc2658"))
