...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/IHproject/IH>";
    const std::string URL_WEBSITE = "<https://IH.org>";
    ...
    while (!fLoaded) {
        ...
        do {
            try {
                ...
                boost::filesystem::path qtumStateDir = GetDataDir() / "stateIH";
