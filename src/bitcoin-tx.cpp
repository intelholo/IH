...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s IH-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  IH-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded IH transaction") + "\n" +
              "  IH-tx [options] -create [commands]   " + _("Create hex-encoded IH transaction") + "\n" +
              "\n";
